  ...
  const info = {
      ...
      parameters: {
          ...
          message: {
              ...
              pretty_name: "Message",
              default: "<p>The experiment is intended to be done in full-screen. The experiment will switch to full screen mode when you press the button below.</p><p></P><P>開始から終了までの間、この実験は全画面で行うことを想定しています。実験の趣旨に同意される場合は、ボタンを押すと全画面に切り替わります。</p>",
              array: false,
          },
